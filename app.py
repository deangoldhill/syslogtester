...
function wireFields(){document.querySelectorAll('button.field').forEach(b=>b.onclick=()=>{document.querySelector('[name=q]').value=b.dataset.key+':"'+b.dataset.value.replaceAll('"','\\"')+'"';messages()})}
